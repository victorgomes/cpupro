import {
  allConvolutionRule,
  moduleConvolutionRule,
  profilePresenceConvolutionRule,
  setSamplesConvolutionRule,
  topLevelConvolutionRule
} from './prepare/computations/samples-convolution.mjs';
import {
  allocTimespan,
  allocTypes,
  FEATURE_MULTI_PROFILES
} from './prepare/const.js';
...
discovery.on('data', () => {
  ...
  if (currentSamplesConvolutionRule) {
    ...
    setSamplesConvolutionRule(profiles, callFramesProfilePresence,
