...
discovery.view.define(
    ...
    function (el, config, data, context) {
        ...
        const subsetTimings =
            rawTimings || new SubsetTreeTimings(value ? new SubsetCallTree(tree, value) : tree, samplesTimings);
                                ...
                                data: [
                                    {
                                        ...
                                        active: tree === profile.categoriesTree
                                    },
                                    ...
                                    {
                                        text: 'Call frames',
                                        value: 'callFramesTree',
                                        active: tree === profile.callFramesTree
                                    }
                                ]
                            }
                        ]
