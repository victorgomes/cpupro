                    ...
                    cols: [
                        ...
                        },
                        {
                            ...
                            content: {
                                view: 'switch',
                                data: 'code.duration',
                                content: [{when: '$', content: 'duration'}, {content: 'text:"—"'}]
                            },
                        ...
                        },
                        {
                            ...
                            content: {
                                ...
                                content: [
                                    ...
                                    {
                                        content:
                                            'html:"<span style=\\"color:#555;font-style:italic\\">missed in V8 log</span>"'
                                    }
                                ]
                            },
                        ...
                        },
                        {
                            ...
                            details: {
                                ...
                                content: [
                                    {
                                        when: 'code.deopt | inliningId = -1 or @.inlined[inliningId]',
                                        content: {
                                            view: 'tree',
                                    ...
                                    {
                                        content:
                                            'html:"<div style=\\"color: #888;padding: 4px 8px\\">Details unavailable because of missed inlining data for the code in V8 log</div>"'
                                    }
                                ]
                            }
                        }
