                ...
                content: [
                    {
                        ...
                        content: [
                            ...
                            {
                                content: ['call-frame-kind-badge:node.value', 'auto-link:node.value']
                            }
                        ]
                    },
                    ...
                    // { view: 'total-time', when: 'children', data: 'totalTime' },
                    {
                        view: 'context',
                        when: 'node.value.id != +#.id',
                        content: ['module-badge:node.value', 'call-frame-loc-badge:node.value']
                    }
                ]
            }
        }
        ...
        header: [
            ...
            {view: 'block', className: 'text-divider'},
            {
                ...
                content: [
                    {
                        when: 'regexp',
                        content: 'text-with-unit{ value: regexp.size() | bytes(), unit: true }'
                    },
                    {
                        when: 'hasSource()',
                        content: 'text-with-unit{ value: end - start | bytes(), unit: true }'
                    },
                    {content: 'html:`<span style="color: #888">(unavailable)</span>`'}
                ]
            }
